'use client';
import { useDeleteMoim } from '@/api/hooks/useMoims';
...
export const MoimDetail = ({ data }: MoimDetailProps) => {
  ...
  return (
    <div className="flex h-full w-full flex-col gap-10 md:p-10">
      <div className="flex h-full w-full flex-col gap-10 rounded-md bg-white p-6 shadow-md md:px-20 md:py-10">
        ...
        <div className="whitespace-pre-line pb-16">{data.content}</div>
      </div>
